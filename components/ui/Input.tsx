...
import { FaEye, FaEyeSlash } from 'react-icons/fa6'; // Assuming react-icons is available, if not use SVGs
        ...
        <div className="w-full relative">
            ...
            <div className="relative">
                <input
                    ...
                    type={inputType}
                    className={cn(
                        'w-full px-4 py-2.5 border border-gray-300 dark:border-gray-800 rounded-lg',
                        'text-black dark:text-white bg-white dark:bg-[#1A1A1A]',
                        'placeholder:text-gray-400 dark:placeholder:text-gray-500',
                        'focus:outline-none focus:ring-1 focus:ring-primary focus:border-primary',
                        'transition-all duration-200',
                        '[&:-webkit-autofill]:shadow-[0_0_0_1000px_#ffffff_inset] dark:[&:-webkit-autofill]:shadow-[0_0_0_1000px_#1A1A1A_inset]',
                        '[&:-webkit-autofill]:[-webkit-text-fill-color:black] dark:[&:-webkit-autofill]:[-webkit-text-fill-color:white]',
                        'disabled:bg-gray-100 disabled:cursor-not-allowed',
                        error && 'border-red-500',
                        isPassword && 'pr-12', // Add padding for password toggle
                        className
                    )}
                    {...props}
                />
