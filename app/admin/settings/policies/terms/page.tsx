...
export default function TermsEditor() {
    ...
    const fetchPolicy = async () => {
        try {
            ...
            if (response.success && (response.data as any)?.policies?.termsOfUse) {
                const policy = (response.data as any).policies.termsOfUse;
                setFormData({
                    enabled: policy.enabled ?? true,
                    title: policy.title || 'Terms of Use',
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (response.success) {
                setMessage({ type: 'success', text: 'Terms of Use saved successfully!' });
                ...
                <div className="bg-white dark:bg-[#1A1A1A] rounded-xl shadow-sm border border-gray-200 dark:border-neutral-200 p-8">
                    <div className="mb-6">
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Terms of Use Editor</h1>
                        </div>
                    ...
                    <div className="space-y-6">
                        <div className="flex items-center gap-3">
                            ...
                            <label htmlFor="enabled" className="text-sm font-medium text-gray-700 dark:text-gray-300">Enable Terms of Use Page</label>
                        </div>
